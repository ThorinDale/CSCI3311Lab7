    ...
    function switchLayout() {
        if (type=='map') {
            ...
            link.transition()
                ...
                .attr('y1', function(d) {
                    return projection([d.source.longtitude, d.source.latitude])[1];
                })
                attr('x2', function(d) {
                    return projection([d.target.longtitude, d.target.latitude])[0];
                })
                attr('y2', function(d) {
                    return projection([d.target.longtitude, d.target.latitude])[1];
                });
